...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> {
  ...
  Future<void> _generateAndSendOTP() async {
    ...
    try {
      ...
      setState(() {
        _isResending = false;
        _resendCountdown = 30; // 30 second cooldown
      });
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: _resendCountdown > 0 || _isResending ? null : _generateAndSendOTP,
                  child: _isResending
                      ? const SizedBox(
                          width: 16,
                          height: 16,
                      ...
                      : Text(
                          _resendCountdown > 0 ? 'Resend in $_resendCountdown sec' : 'Resend Code',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            fontWeight: FontWeight.w600,
                            color: _resendCountdown > 0 ? Colors.grey : const Color(0xFF1E88E5),
                          ),
                        ),
                ),
              ],
